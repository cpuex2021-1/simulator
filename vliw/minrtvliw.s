...
nop; 	fmul f0, f1, f0; nop; nop; 
nop; nop; nop; 	sw f0, 0(a0); 
nop; 	addi sp, sp, -5; nop; 	lw f0, -2(sp); 
	call cos; nop; nop; nop; 
...
nop; 	addi sp, sp, -3; nop; 	lw a0, 0(sp); 
	call create_float_array; nop; nop; nop; 
	lui.float f0, 0.000000; 	addi sp, sp, 3; nop; nop; 
nop; 	addi.float f0, f0, 0.000000; nop; 	lw a1, -1(sp); 
...
nop; 	addi sp, sp, -7; nop; 	lw a0, -3(sp); 
	call create_array; nop; nop; nop; 
	lui a1, 4096; 	addi sp, sp, 7; nop; nop; 
...
nop; 	addi sp, sp, -17; nop; 	sw a3, -14(sp); 
	call create_float_array; nop; nop; nop; 
...
nop; 	addi sp, sp, -25; nop; 	sw f1, -22(sp); 
	call create_float_array; nop; nop; nop; 
...
nop; nop; nop; 	lw a0, -17(sp); 
nop; nop; nop; 	sw a0, 0(a1); 
nop; 	addi sp, sp, -27; nop; 	lw a0, -16(sp); 
	call create_array; nop; nop; nop; 
...
nop; nop; nop; 	sw a0, 0(a1); 
nop; 	addi sp, sp, -55; nop; 	lw a0, -45(sp); 
	call create_array; nop; nop; nop; 
...
nop; nop; nop; 	sw a0, 0(a1); 
nop; 	addi sp, sp, -85; nop; 	lw a0, -74(sp); 
	call create_array; nop; nop; nop; 
